...
-- Fix 1: Set search_path in function public.update_projects_updated_at
...
-- Fix 2: Set search_path in function public.calculate_material_metrics
...
-- For the OTP expiry (`auth_otp_long_expiry`), update this in the Supabase dashboard, under Authentication > Settings > OTP Expiry (to be ≤ 3600 seconds).
-- No SQL is required for OTP expiry, just change the value in your dashboard as described.
